...
swarm_msgs::Formation formation_cmd;
...
int main(int argc, char **argv)
{
    ...
    ros::Publisher formation_pub = nh.advertise<swarm_msgs::Formation>("/swarm/formation_cmd", 10);
    int CMD = 0;
    ...
    while (ros::ok())
    {
        ...
        {
        case 1:
            formation_cmd.cmd = swarm_msgs::Formation::FORMATION;
            formation_cmd.formation_type = swarm_msgs::Formation::STATIC;
        ...
        case 5:
            formation_cmd.cmd = swarm_msgs::Formation::FORMATION;
            formation_cmd.formation_type = swarm_msgs::Formation::DYNAMIC;
        ...
        case 7:
            formation_cmd.cmd = swarm_msgs::Formation::FORMATION;
            formation_cmd.formation_type = swarm_msgs::Formation::LEADER;
            formation_pub.publish(formation_cmd);
            break;

        case 101:
        {
            formation_cmd.cmd = swarm_msgs::Formation::TAKEOFF;
            formation_cmd.name = "";
            formation_pub.publish(formation_cmd);
            break;
        }
        case 102:
        {
            formation_cmd.cmd = swarm_msgs::Formation::LAND;
            formation_cmd.name = "";
            formation_pub.publish(formation_cmd);
            break;
        }
        case 103:
            formation_cmd.cmd = swarm_msgs::Formation::HOVER;
            formation_cmd.name = "";
            formation_pub.publish(formation_cmd);
            break;
        case 104:
            formation_cmd.cmd = swarm_msgs::Formation::SET_HOME;
            formation_cmd.name = "";
            formation_pub.publish(formation_cmd);
            break;
        case 105:
            formation_cmd.cmd = swarm_msgs::Formation::RETURN_HOME;
            formation_cmd.name = "";
            formation_pub.publish(formation_cmd);
            break;
        }
