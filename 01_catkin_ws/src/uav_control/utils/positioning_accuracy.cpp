...
public:
    ErrorEstimation(ros::NodeHandle &nh)
    {
        ...
        uav_state_sub = nh.subscribe<swarm_msgs::UAVState>(topic_prefix + "/uav_state",
                                                            10, &ErrorEstimation::uav_state_callback, this);
        control_cmd_pub = nh.advertise<swarm_msgs::UAVControlCMD>(topic_prefix + "/uav_control_cmd", 1);
        uav_setup_pub = nh.advertise<swarm_msgs::UAVSetup>(topic_prefix + "/setup", 1);
