...
int swarm_logger::Logger::precision;             // 小数点精度
bool swarm_logger::Logger::printLevel;           // 是否打印level
bool swarm_logger::Logger::printTime;            // 是否打印时间
bool swarm_logger::Logger::printToFile;          // 是否输出到文件
bool swarm_logger::Logger::is_openFile;          // 是否打开了文件
bool swarm_logger::Logger::is_init;              // 是否初始化
std::string swarm_logger::Logger::delimiter{" "};     // 分隔符
std::string swarm_logger::Logger::printColor;    // 设置默认颜色
std::string swarm_logger::Logger::printLevelStr; // 设置默认level
std::string swarm_logger::Logger::fileName;      // 文件路径+文件名
std::fstream swarm_logger::Logger::f_stream;     // 文件输出流对象
std::array<std::string, 28> swarm_logger::Logger::colors;
std::array<std::string, 5> swarm_logger::Logger::levels;
